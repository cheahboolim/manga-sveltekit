...
export const load: PageServerLoad = async ({ url, locals }) => {
	...
	const meta = {
		title:
			page > 1
				? `Search results for "${query}" – Page ${page} | SusManga`
				: `Search results for "${query}" | SusManga`,
		description: `Discover manga results for "${query}" on SusManga. Page ${page} of ${totalPages}.`,
